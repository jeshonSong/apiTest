...
public class RestClient {
	 ...
	 * @throws IOException
	 */
	public CloseableHttpResponse get(String url, Map<String, String> headermap)
	 ...
	 * @throws IOException
	 */
	public CloseableHttpResponse post(String url, String entityString, Map<String, String> headermap)
			throws ClientProtocolException, IOException {
		// 创建一个可关闭的HttpClient对象
		CloseableHttpClient httpclient = HttpClients.createDefault();
		// 创建一个HttpPost的请求对象
	 ...
	 * @throws IOException
	 */
	public CloseableHttpResponse put(String url, String entityString, Map<String, String> headerMap)
			throws ClientProtocolException, IOException {
